...
//
{
  ...
  {
    f5[i] = y[i] + ch *
                       (1932.0 * yp[i] + (7296.0 * f2[i] - 7200.0 * f1[i]));
  }
  ...
  {
    f5[i] = y[i] + ch *
                       ((8341.0 * yp[i] - 845.0 * f3[i]) + (29440.0 * f2[i] - 32832.0 * f1[i]));
  }
  ...
  {
    f1[i] = y[i] + ch *
                       ((-6080.0 * yp[i] + (9295.0 * f3[i] - 5643.0 * f4[i])) + (41040.0 * f1[i] - 28352.0 * f2[i]));
  }
  ...
  {
    s[i] = y[i] + ch *
                      ((902880.0 * yp[i] + (3855735.0 * f3[i] - 1371249.0 * f4[i])) + (3953664.0 * f2[i] + 277020.0 * f5[i]));
  }
  ...
  for (;;)
  {
    ...
    for (;;)
    {
      ...
      for (k = 0; k < neqn; k++)
      {
        ...
        ee = r4_abs((-2090.0 * yp[k] + (21970.0 * f3[k] - 15048.0 * f4[k])) + (22528.0 * f2[k] - 27360.0 * f5[k]));
  ...
  for (;;)
  {
    ...
    for (;;)
    {
      ...
      for (k = 0; k < neqn; k++)
      {
        ...
        ee = r8_abs((-2090.0 * yp[k] + (21970.0 * f3[k] - 15048.0 * f4[k])) + (22528.0 * f2[k] - 27360.0 * f5[k]));
